...
ax[0,0].imshow(img)
ax[0,0].axis('off')
ax[0,0].set_tittle("original")

#3-2. 회전 이미지 
ax[0,1].imshow(img_rotated)
ax[0,1].axis('on')
ax[0,1].set_tittle("Rotated 90")

#3-3. 밝기 이미지
ax[0,2].imshow(img_brightness)
ax[0,2].axis('off')
ax[0,2].set_tittle("Brightness")

#3-4. 좌우 반전 이미지 
ax[1,0].imshow(img_flip)
ax[1,0].axis('off')
ax[1,0].set_tittle("Flip")

plt.show()

img_rotated("./img_rotated.jpg")
img_brightness("./img_brightness.jpg")
img_flip("./img_flip.jpg")
